...
exports.comparePassword = (password, dataPassword) => __awaiter(void 0, void 0, void 0, function* () {
    const passwordMatch = yield bcrypt_1.default.compare(password, dataPassword);
